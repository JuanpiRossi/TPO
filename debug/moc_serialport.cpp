...
QT_MOC_LITERAL(1, 11, 9), // "beginGame"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "enviarMsgTimer"
QT_MOC_LITERAL(4, 37, 8), // "readData"
QT_MOC_LITERAL(5, 46, 22), // "envioConfirmacionTimer"
QT_MOC_LITERAL(6, 69, 17) // "envioReenvioTimer"

    },
    "serialPort\0beginGame\0\0enviarMsgTimer\0"
    "readData\0envioConfirmacionTimer\0"
    "envioReenvioTimer"
};
...
void serialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->beginGame(); break;
        case 1: _t->enviarMsgTimer(); break;
        case 2: _t->readData(); break;
        case 3: _t->envioConfirmacionTimer(); break;
        case 4: _t->envioReenvioTimer(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serialPort::beginGame)) {
                *result = 0;
                return;
            }
        }
